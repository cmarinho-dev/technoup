...
INSERT IGNORE INTO produto (id, nome, preco, tipo, descricao, modelo, marca)
VALUES (1, 'SSD NVMe 1TB', 499.90, 'Armazenamento', 'SSD NVMe M.2 com alta performance', 'M.2 2280', 'FastDisk'),
       (2, 'Memória RAM 16GB (2x8) DDR4', 249.99, 'Memória', 'Kit 16GB 3200MHz', 'UDIMM', 'HyperMem'),
       (3, 'Monitor 27\" 144Hz', 1299.00, 'Periférico', 'Monitor 27 polegadas 144Hz Full HD', 'VG27', 'ViewPro'),
       (4, 'Teclado Mecânico RGB', 199.50, 'Periférico', 'Teclado mecânico com switches vermelhos', 'MK-Red', 'KeyPro'),
       (5, 'Placa de Vídeo GTX 1660 6GB', 1599.00, 'Placa de Vídeo', 'GPU 6GB GDDR5 para jogos', 'GTX1660', 'Graphix');

INSERT IGNORE INTO catalogo (produto_id, loja_id)
VALUES (1, 1),
       (1, 2),
       (2, 1),
       (3, 2),
