  ...
  <div class="relative inline-block text-left" id="profile-menu-container">
    ...
    <div id="profile-dropdown" class="hidden absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden transition-all duration-200 ease-in-out" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
      <div class="py-1">
        ...
        <a href="#" class="block px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors" role="menuitem" tabindex="-1" id="menu-item-2">
          <div class="flex items-center gap-2">
      ...
      <div class="border-t border-slate-100 py-1">
        <form method="POST" action="../_php/logoff.php" class="block m-0">
          <button type="submit" class="w-full text-left px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 transition-colors" role="menuitem" tabindex="-1" id="menu-item-3">
