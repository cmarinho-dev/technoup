...
<div class="flex min-h-screen w-full bg-white">
    <div class="flex-1 flex flex-col justify-center px-8 lg:flex-none lg:w-1/2 lg:px-16 xl:px-24">
        <div class="w-full max-w-sm mx-auto">
            ...
            <p class="text-sm text-slate-500 mb-8">Não possui uma conta? <a href="../registro/"
                                                                            class="font-semibold text-blue-600 hover:text-blue-700 hover:underline transition-colors">Crie
                    uma conta</a></p>
            ...
            <form action="" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-between pt-1 pb-1">
                    <div class="flex items-center gap-2 relative">
                        ...
                        <svg class="absolute w-2.5 h-2.5 text-white left-[3px] pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                             stroke-width="4" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="20 6 9 17 4 12"></polyline>
                        </svg>
                        <label for="remember" class="text-sm text-slate-600 cursor-pointer select-none">Lembrar de
                            mim</label>
                    </div>
                    <a href="#"
                       class="text-sm font-semibold text-blue-600 hover:text-blue-700 hover:underline transition-colors">Esqueceu
                        sua senha?</a>
                </div>
                <button type="submit"
