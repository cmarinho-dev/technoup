    ...
    if (usuario.tipo === 'lojista') {
        opcoes += `
            ...
            <a href="${CAMINHO_FRONTEND}/protegido/lojas/chats.html"
               class="block px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                <div class="flex items-center gap-2">
                    <i data-lucide="messages-square" class="h-4 w-4 text-slate-400"></i>
                    Chats da loja
                </div>
            </a>
        `;
        ...
        opcoes += `
            <a href="${CAMINHO_FRONTEND}/formulario.html"
               class="block px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                <div class="flex items-center gap-2">
                    <i data-lucide="badge-dollar-sign" class="h-4 w-4 text-slate-400"></i>
                    Venda seu item
                </div>
            </a>
            <a href="${CAMINHO_FRONTEND}/protegido/consumidor/conversas.html"
               class="block px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                <div class="flex items-center gap-2">
                    <i data-lucide="messages-square" class="h-4 w-4 text-slate-400"></i>
                    Minhas conversas
